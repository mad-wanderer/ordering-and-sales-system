namespace ordering_and_sales_system.Domain.Entities
{
    public class PendingOrders : IPendingOrders
    {
        ...
        public PendingOrders(string? orderID, string? productID, string? customerID, string? productName, string? color, int quantity, int price, DateTime? transactionDate, string? status, int total)
        {
            OrderID = orderID;
            ProductID = productID;
